...
public class listbuyproductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listbuyproduct);

        if(getIntent().getExtras() != null) {
            produit = getIntent().getStringExtra("commandes");
            Gson gsonc= new Gson();
            value=gsonc.fromJson(produit,Produit.class);
        }
        findView();
    ...
    private void initdata() {
       /* codedata=value.Photo_Produit.replace("data:image/jpeg;base64,","");
        ...
        txtentr.setText(value.Nom_Entreprise);
        txttitle.setText(value.Nom_Produit);
        txtprice.setText(value.PrixU_Produit);
    }
    ...
    public void onlogout(View view) {
        startActivity(new Intent(listbuyproductActivity.this,MainActivity.class));
        finish();
    }
                ...
                builder
                        ...
                        .setPositiveButton(getString(R.string.button_ok), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                startActivity(new Intent(listbuyproductActivity.this, Home_Activity.class));
                            }
                        })
