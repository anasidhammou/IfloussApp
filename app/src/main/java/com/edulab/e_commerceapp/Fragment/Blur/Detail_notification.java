...
public class Detail_notification extends DialogFragment {
    ...
    public Detail_notification() {
    }

    public static Detail_notification newInstance() {
        Detail_notification fragment = new Detail_notification();
    ...
    private void initData() {
        ...
        try {
            Notif notif=(Notif) object;
            datenotif.setText(notif.dateNotif);
            titlenotif.setText(notif.TitleNotif);
            descriptionnotif.setText(notif.DescriptionNotif);
        }catch (Exception e){
